...
trainlen = 9380-valid # total number of available signal data =  trainlen (#data used for training) + valid (#data used for val)
trainbeg = 0
...
np.savetxt('RSPA19_Ex2_9380-4_100ens.csv',np.c_[osol], delimiter=',')  