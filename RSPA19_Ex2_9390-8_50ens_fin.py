...
trainlen = 9390-valid # total number of available signal data =  trainlen (#data used for training) + valid (#data used for val)
trainbeg = 0
...
np.savetxt('RSPA19_Ex2_9390-8_100ens.csv',np.c_[osol], delimiter=',')  