...
#print info
print('Total number of data points given: ',trainlen+valid) #total given = this + 1
...
while k < n_ens and count <= max_iter:
    ...
    if min_error <= threshold:
        ...
        if otest_error/itest_error <= 1000000000:
            print("----------------------------------------------------------------------")
            print("=====================================================>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Run #: ", k)
	    ...
	    osol[k,:] = oprediction.reshape((future,))
	    k+=1
        
np.savetxt('RSPA19_Ex2_9410-8_50ens_baseline.csv',np.c_[osol], delimiter=',')  