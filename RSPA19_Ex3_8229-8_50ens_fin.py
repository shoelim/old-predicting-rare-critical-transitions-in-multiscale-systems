...
valid = 8 # a choice
future = 41+valid # # signal data used for validation
trainlen = 8229-valid # total number of available signal data =  trainlen (#data used for training) + valid (#data used for val)
trainbeg = 200
...
np.savetxt('RSPA19_Ex3_8229-8_100ens.csv',np.c_[osol], delimiter=',')  