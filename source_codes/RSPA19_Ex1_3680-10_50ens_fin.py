...
future = 620+valid # signal data used for validation
trainlen = 3680-valid # total number of available signal data =  trainlen (#data used for training) + valid (#data used for val)
trainbeg = 0
...
np.savetxt('RSPA19_Ex1_3680-10_100ens_fin.csv',np.c_[osol], delimiter=',')   
