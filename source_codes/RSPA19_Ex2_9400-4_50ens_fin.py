...
trainlen = 9400-valid # total number of available signal data =  trainlen (#data used for training) + valid (#data used for val)
trainbeg = 0
...
np.savetxt('RSPA19_Ex2_9400-4_100ens.csv',np.c_[osol], delimiter=',')  