...
valid = 8 # a choice
future = 39+valid # # signal data used for validation
trainlen = 8231-valid # total number of available signal data =  trainlen (#data used for training) + valid (#data used for val)
trainbeg = 200
...
np.savetxt('RSPA19_Ex3_8231-8_100ens.csv',np.c_[osol], delimiter=',')  